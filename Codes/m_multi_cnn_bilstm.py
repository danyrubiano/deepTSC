...
"""
CNN-BiLSTM Multi-headed Architecture
...
def multi_cnn_bilstm(X_train, y_train, X_test, y_test, epochs, batch_size, path, earlystop):
    ...
    lstm2 = LSTM(100, return_sequences=True)(pool2)
    flat2 = Flatten()(lstm2)
    ...
    lstm3 = LSTM(100, return_sequences=True)(pool3)
    flat3 = Flatten()(lstm3)
