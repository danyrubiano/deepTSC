...
"""
CNN and BiLSTM Multi-headed Architecture
...
def multi_cnn_bilstm2(X_train, y_train, X_test, y_test, epochs, batch_size, path, earlystop):
    ...
    conv2 = Conv1D(filters=64, kernel_size=3, activation='relu')(inputs_layer2)
    ...
    lstm1 = LSTM(100, return_sequences=True)(merged)
    flat3 = Flatten()(lstm1)


    # interpretation
    dense1 = Dense(100, activation='relu')(flat3)
