...
"""
CNN, CNN-LSTM and LSTM Multi-headed Architecture
...
def cnn_lstm_separated2(X_train, y_train, X_test, y_test, epochs, batch_size, path, earlystop):
    ...
    conv2 = Conv1D(filters=64, kernel_size=11, activation='relu')(inputs_layer2)
    ...
    lstm3 = LSTM(100)(inputs_layer3)
    drop3 = Dropout(0.5)(lstm3)

    # merge
    merged = concatenate([flat1, lstm2, drop3])
    # interpretation
